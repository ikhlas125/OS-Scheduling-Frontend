...
const SJB = () => {
  ...
  const simulateSJF = async () => {
    ...
    try {
      ...
      const response = await fetch("http://localhost:5000/api/schedule/sjb", {
        method: "POST",
  ...
  return (
    <div className="fcfs-container">
      ...
      <div className="header">
        ...
        <p>
          Processes with the shortest burst time are selected first for
          execution.Efficient in reducing average waiting time.
        </p>
      </div>
