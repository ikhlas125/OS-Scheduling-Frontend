...
const RR = () => {
  ...
  const [timeQuantum, setTimeQuantum] = useState(2); // Default time quantum
  ...
  return (
    <div className="fcfs-container">
      ...
      <div className="header">
        ...
        <p>
          Each process gets a fixed time slot (quantum) for execution. Fair CPU
          time allocation with reduced starvation.
        </p>
      </div>
