...
const PriorityNon = () => {
  ...
  const simulatePrioritNon = async () => {
    setLoading(true);
    setError("");
    setResults(null);
  ...
  return (
    <div className="fcfs-container">
      ...
      <div className="header">
        <h1>Priority Non-Preemprive Scheduling</h1>
        <p>
          Processes are executed based on priority without preemption. Simple
          but may cause starvation for lower-priority processes.
        </p>
      </div>
        ...
        <div className="controls">
          ...
          >
            {loading ? (
              ...
              "Run Priority Non Preemptive Simulation"
            )}
          </button>
        </div>
      </div>
